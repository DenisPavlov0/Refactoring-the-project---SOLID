...
namespace Completed
{
    ...
    public class Enemy : MovingObject
    {
        ...
        private ICharacterAttackAnimations _characterAttackAnimations;
        protected override void Start()
        {
            ...
            _characterAttackAnimations = new EnemyAnimations(GetComponent<Animator>());
        ...
        protected override void OnCantMove<T>(T component)
        {
            ...
            _characterAttackAnimations.SetAttack();
